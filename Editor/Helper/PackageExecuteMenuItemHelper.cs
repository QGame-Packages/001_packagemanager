...
namespace ET.Editor.PackageManager
{
    ...
    public static class PackageExecuteMenuItemHelper
    {
        ...
        {
            ExecuteMenuItem("Tools/Init/RepairDependencies");
        }

        public static void ET_Loader_ReGenerateProjectFiles()
        {
            ExecuteMenuItem("ToolsLoader/ReGenerateProjectFiles");
        }

        public static void ET_Loader_ReGenerateProjectAssemblyReference()
        {
            ExecuteMenuItem("Tools/Loader/ReGenerateProjectAssemblyReference");
        }

        public static void ET_Loader_UpdateScriptsReferences()
        {
            ExecuteMenuItem("Tools/Loader/UpdateScriptsReferences");
        }

        public static void ET_Excel_ExcelExporter()
        {
            //关闭此功能 改为手动执行
            ExecuteMenuItem("Tools/Excel/ExcelExporter");
        }

        public static void ET_Proto_Proto2CS()
        {
            ExecuteMenuItem("Tools/Proto/Proto2CS");
        }
