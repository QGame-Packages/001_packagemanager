...
namespace ET.Editor.PackageManager
{
    ...
    {
        [MenuItem("Tools/ETPackage 包管理自动化工具")]
        ...
        //[MenuItem("Tools/关闭ETPackage 包管理自动化工具")]
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            var assembly = GetAssembly(PackageConst.AssemblyName);
            if (assembly == null)
            {
                return null;
            }
            ...
            foreach (var type in types)
            {
                ...
                var attribute =
                    (ETPackageMenuAttribute)Attribute.GetCustomAttribute(type, typeof (ETPackageMenuAttribute));
        ...
        private BaseTreeMenuItem NewTreeMenuItem(Type moduleType, string moduleName)
        {
            ...
            var constructor = specificTreeMenuItemType.GetConstructor(new[]
            {
            ...
            var treeMenuItem = constructor.Invoke(new object[]
            {
                this,
                m_OdinMenuTree,
                moduleName
