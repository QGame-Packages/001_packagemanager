...
namespace ET.Editor.PackageManager
{
    ...
    public class ETPackageHubModule: BasePackageToolModule
    {
        ...
        private void CreateCategory()
        {
            ...
            var allName = nameof (EPackageCategoryType.All);
            var otherName = nameof (EPackageCategoryType.Other);
        ...
        private void CreateCategoryItem(string categoryName, EPackageCategoryType categoryType,
            List<PackageHubData> categoryData)
        {
            ...
            {
                UserData = new PackageCategoryData
                {
